...
namespace GS4_Calibration_Utility
{
	internal static class Yeisrvo
	{
		...
		[DllImport("yeisrvo.dll", CharSet=CharSet.Ansi, ExactSpelling=true, SetLastError=true)]
		public static extern short GetPresetControlData(int Comm, int BoardNum, int PresetSlot, ref Yeisrvo.SCControlData PresetData);
		...
		[DllImport("yeisrvo.dll", CharSet=CharSet.Ansi, ExactSpelling=true, SetLastError=true)]
		public static extern short SetPresetControlData(int Comm, int BoardNum, Yeisrvo.SCControlData PresetData);
